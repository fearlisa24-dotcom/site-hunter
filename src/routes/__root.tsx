...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Scoutly — Find your next website client" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Scoutly" },
      { property: "og:title", content: "Scoutly — Find your next website client" },
      {
        property: "og:description",
        content: "Discover businesses without websites, research with AI, and win more clients.",
      },
